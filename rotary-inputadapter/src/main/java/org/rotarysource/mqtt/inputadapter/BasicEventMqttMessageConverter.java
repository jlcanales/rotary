	...
	*/	 
	...
	public Object fromMessage(String topic, MqttMessage message) throws MqttException {
		...
		try {
			...
			StringBuffer errorText = new StringBuffer("Error parsing input message. Bad Format. ");
			if(log.isDebugEnabled()){
				errorText.append("Nexted exception: ").append(except.getMessage());
			}
			errorText.append(" Message : ").append(message.toString());
			log.error(errorText.toString());

			throw new MqttException(MqttException.REASON_CODE_UNEXPECTED_ERROR, except);
